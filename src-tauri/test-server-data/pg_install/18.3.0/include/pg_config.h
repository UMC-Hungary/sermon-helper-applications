...
#define CONFIGURE_ARGS " '--prefix' '/Users/runner/work/postgresql-binaries/postgresql-binaries/postgresql-18.3.0-aarch64-apple-darwin' '--enable-integer-datetimes' '--enable-option-checking=fatal' '--without-icu' '--without-ldap' '--with-libxml' '--with-libxslt' '--with-openssl' '--with-pgport=5432' '--with-readline' '--with-system-tzdata=/usr/share/zoneinfo' '--with-uuid=e2fs' 'LDFLAGS=-L/opt/homebrew/opt/icu4c/lib -L/opt/homebrew/opt/openssl/lib' 'CPPFLAGS=-I/opt/homebrew/opt/icu4c/include -I/opt/homebrew/opt/openssl/include' 'LLVM_CONFIG=/opt/homebrew/opt/llvm/bin/llvm-config'"
...
/* Define to 1 if you have the declaration of `timingsafe_bcmp', and to 0 if
   you don't. */
#define HAVE_DECL_TIMINGSAFE_BCMP 1
...
#define PG_VERSION_STR "PostgreSQL 18.3 on aarch64-apple-darwin24.6.0, compiled by Apple clang version 17.0.0 (clang-1700.0.13.5), 64-bit"
...
#define USE_SVE_POPCNT_WITH_RUNTIME_CHECK 1
